...
* **`Report.pdf`**: The complete academic report. Includes mathematical proofs of the OLG propositions and detailed country-level case studies (USA vs. Norway vs. China).
* **`Cultural_Analysis.py`**: The full Python script used for data cleaning, merging, and visualization.
* **`Data/`**: Contains snapshots of the datasets used (Note: Full GPS data available via the Briq Institute).

---

*Author: [Your Name]*
*University Project | Behavioral Macroeconomics*
